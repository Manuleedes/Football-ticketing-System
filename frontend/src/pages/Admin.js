...
export function Courts() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setIsLoading(true);
                const response = await axios.get("http://localhost:3000/api/courts/getAllCourts");
    ...
    async function deleteCourt(id) {
        try {
            const response = await fetch("http://localhost:3000/api/courts/deleteCourt/${id}", {
                method: 'DELETE',
            });
...
export function AddCourt() {
    ...
    async function addCourt() {
        ...
        try {
            setIsLoading(true);
            const response = await axios.post("http://localhost:3000/api/courts/addCourt", newCourt);
...
export function UpdateCourt() {
    ...
    async function updateCourt(id) {
        ...
        try {
            const response = await fetch("http://localhost:3000/api/courts/updateCourt/${id}", {
                method: 'PUT',
                headers: {
